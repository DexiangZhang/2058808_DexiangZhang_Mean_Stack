function itemsDisplay(): void {
    ...
    (document.querySelector("#table") as HTMLInputElement).innerHTML = tableContent;
    (document.querySelector("#cost") as HTMLInputElement).innerHTML = statement;
